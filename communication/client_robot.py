...
from communication.client_generic import ClientGeneric
from communication.messages.messagetypes import MSG_CURRENT_POSE_CARTESIAN, MSG_CURRENT_POSE_JOINT, MSG_COMMAND_RECEIVED, MSG_COMMAND_EXECUTED, \
                                MSG_COMMAND, MSG_STOP, MSG_STRING, MSG_FLOAT_LIST, \
                                arm_msg_types_str_array,MSG_CURRENT_POSE_CARTESIAN_BASE

from communication.messages.clientstates import STATE_READY, STATE_READY_TO_RECEIVE, STATE_EXECUTING
...
class ClientRobot(ClientGeneric): #former: inherited from Thread
    ...
    def _send_command(self, cmd):
        ...
        [msg_type, msg_counter, timestamp_sec, timestep_nanosec, cmd_type, float1-float10, int_vel, float_duration, int_zone, int_tool, float_arbitrary, int_wobj, int_rob_num]
        """
