...
def _connect_to_single_robot(rob_num):
    ...
    if rob_num == 1:
        abb.send(rrc.SetWorkObject("ecl_rob1_zerowaste"))
        abb.send(rrc.SetTool("ecl_rob1_pneumatic_gripper"))
        ...
        abb.send(rrc.SetWorkObject("ecl_rob2_zerowaste"))
        abb.send(rrc.SetTool("ecl_rob2_pneumatic_gripper"))
        # abb.send(rrc.SetMaxSpeed(override=100, max_tcp=10000))
        ...
        abb.send(rrc.SetTool("ecl_rob3_pneumatic_gripper"))
